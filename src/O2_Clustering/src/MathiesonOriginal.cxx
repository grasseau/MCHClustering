...
void MathiesonOriginal::setSqrtKx3AndDeriveKx2Kx4(float sqrtKx3) {
  /// set the Mathieson parameter sqrt(K3) in x direction, perpendicular to the
  /// wires, and derive the Mathieson parameters K2 and K4 in the same direction
  mSqrtKx3 = sqrtKx3;
...
//_________________________________________________________________________________________________
float MathiesonOriginal::integrate(float xMin, float yMin, float xMax,
                                   float yMax) const {
  ...
  return static_cast<float>(4. * mKx4 *
                            (TMath::ATan(uxMax) - TMath::ATan(uxMin)) * mKy4 *
                            (TMath::ATan(uyMax) - TMath::ATan(uyMin)));
}
