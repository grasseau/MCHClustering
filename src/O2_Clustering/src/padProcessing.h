...
int checkConsistencyMapKToIJ( const char *matrix, const MapKToIJ_t *mapKToIJ, const PadIdx_t *mapIJToK, const PadIdx_t *aloneIPads, const PadIdx_t *aloneJPads, int N0, int N1, int nbrOfProjPads);
PadIdx_t *buildFirstNeighbors( const Pads &pads, int verbose);
