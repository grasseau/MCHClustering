...
void fastIterateEMPoisson( const double* Cij, const double* Ci, const double* qPixels, const double* qPad, double *qPadPrediction,
        int nPixels, int nPads, double *newQPixels) {
              ...
              int qCutMode, double minPadResidu, int nItMax, int n0 )
{
  ...
  while( !converge ) {
    ...
    */
    ...
    // iterateEMPoisson( Cij, Ci, maskCij, qPixels, qPads, qPadPrediction, nPixels, nPads, qPixels);
    fastIterateEMPoisson( Cij, Ci, qPixels, qPads, qPadPrediction, nPixels, nPads, qPixels);
    // }
    ...
    converge = (meanPixelsResidu < 1.0e-12) || (meanPadResidu < minPadResidu) || (it>nItMax);
    it += 1;
  }
