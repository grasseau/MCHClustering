...
struct ClusterizerParam
    : public o2::conf::ConfigurableParamHelper<ClusterizerParam> {
  ...
  double mathiesonSqrtKx3St1 =
      0.7000; ///< Mathieson parameter sqrt(K3) in x direction for station 1
  double mathiesonSqrtKx3St2345 = 0.7131; ///< Mathieson parameter sqrt(K3) in x
                                          ///< direction for station 2 to 5

  double mathiesonSqrtKy3St1 =
      0.7550; ///< Mathieson parameter sqrt(K3) in y direction for station 1
  double mathiesonSqrtKy3St2345 = 0.7642; ///< Mathieson parameter sqrt(K3) in y
                                          ///< direction for station 2 to 5

  double defaultClusterResolution = 0.2; ///< default cluster resolution (cm)
  double badClusterResolution =
      10.; ///< bad (e.g. mono-cathode) cluster resolution (cm)
