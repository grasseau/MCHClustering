...
class Pads {
 public:
  ...
  static constexpr double epsilonGeometry = 1.0e-04;  // Uncertainty on pad location (in cm) 
 ...
 private:
  ...
  PadIdx_t *buildFirstNeighbors( double *X, double *Y, double *DX, double *DY, int N );
  void setToZero();
};
