...
def findSeeds(pad0, pad1, theta, chId):
  (x0, y0, dx0, dy0, z0) = pad0
  (x1, y1, dx1, dy1, z1) = pad1
  
  zMaxIdx0 = np.argmax( z0 )
  print("???", zMaxIdx0)
  refPad0 = ( x0[zMaxIdx0],  y0[zMaxIdx0], dx0[zMaxIdx0], dy0[zMaxIdx0])
  
  mask1 = intersection( refPad0, pad1)
  print("??? mask1", mask1)
  zMaxIdx1 = np.argmax( z1*mask1)
  padMax1 = ( x1[zMaxIdx1],  y1[zMaxIdx1], dx1[zMaxIdx1], y1[zMaxIdx1])
  print("??? zMaxIdx1", zMaxIdx1)
  
  ( u, v ) = getPoint(refPad0, padMax1)
  print("Point, u/v", u, v)
  w, mux, muy, varx, vary = theta 
  w.append( (z0[zMaxIdx0] + z1[zMaxIdx1]) *0.5 )
  mux.append(u)
  muy.append(v)
  varx.append(0.1)
  vary.append(0.1)
...
if __name__ == "__main__":
    ...
    theta = ([],[],[],[],[])
    t = findSeeds( (x0, y0, dx0, dy0, z0), (x1, y1, dx1, dy1, z1), theta, chId )
    print("t ???", t)
    newTheta = tUtil.thetaListAsTheta(t)
