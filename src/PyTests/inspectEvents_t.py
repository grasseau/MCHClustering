...
import math
from mpl_toolkits.mplot3d import axes3d  # Fonction pour la 3Dessing
...
def displayTracks ( recoTracks, gemTracks):
  gemX = []; gemY = []; gemZ = []; 
  """
    gemX.append( X )
    gemY.append( Y )
...
if __name__ == "__main__":
  ...
  for ev in range(0, nEvents):
    recoTracks = RecoTracks.tracks[ev]
    gemTracks = GEMTracks.tracks[ev]
    displayTracks( recoTracks, gemTracks)
